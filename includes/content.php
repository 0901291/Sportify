	    ...
	    case 15:
	        function printProfilePlaylists ($conn)
	        {
	            ...
	            while ($row = $data -> fetch_assoc()) {
	                echo '<tr data-page="16" data-transition="slide" data-item="'. $row["idPlaylists"] .'" class="page-navigation border-bottom playlist"> <td style="width: 74px" class="albumart"><img src="'. $row["image"] . '"></td><td style="width: 74px; display: none;" class="delete_td"><input type="checkbox" id="' . $row["idPlaylists"] . '" value="' . $row["idPlaylists"] . '"><label for="' . $row["idPlaylists"] . '"></td><td>'. $row["name"] . '</td> <td> '. $row["BPM"] . '</td></tr>';
	            }
